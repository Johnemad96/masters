...
get_filename_component(_filename "/home/workspace/catkin_ws/src/learning_tf2/srv/evaluateSLAMEvo.srv" NAME_WE)
add_custom_target(_learning_tf2_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "learning_tf2" "/home/workspace/catkin_ws/src/learning_tf2/srv/evaluateSLAMEvo.srv" ""
)
...
_generate_srv_cpp(learning_tf2
  "/home/workspace/catkin_ws/src/learning_tf2/srv/evaluateSLAMEvo.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_tf2)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_tf2\")")
  # install generated code
  install(
